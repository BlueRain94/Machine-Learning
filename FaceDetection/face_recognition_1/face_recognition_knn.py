...
def show_prediction_labels_on_image(img_path, predictions):
    ...
    #pil_image.show()
    pil_image.save("../../input/face_regcognition/result/" + os.path.basename(img_path))


if __name__ == "__main__":
    train_dir = "../../input/face_regcognition/people"
    test_dir = "../../input/face_regcognition/test"
