...
if platform.system() == "Windows":
	...
	path_to_poppler_exe = Path(r"D:\Code\my-repo\python\pdf\poppler-22.04.0\Library\bin")
...
PDF_file = Path(r"math_exam.pdf")

# Store all the pages of the PDF in a variable
image_file_list = []

text_file = out_directory / Path("math_exam.txt")
